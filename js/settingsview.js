...
(function (OC, Handlebars, $) {
    ...
    var TEMPLATE = '<div>'
        ...
        + '	   <label for="totp-challenge" class="hidden-visually">' + t('twofactor_totp', 'Authentication code') + '</label>'
        + '	   <input type="text" id="totp-challenge" required="required" inputmode="numeric" pattern="[0-9]*" minlength="6" maxlength="6" autocomplete="off" placeholder="' + t('twofactor_totp', 'Authentication code') + '">'
